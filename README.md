...
- RequireJS 2.3.1 (http://requirejs.org/docs/download.html)
- RequireJS text 2.0.15 (https://github.com/requirejs/text)
- D3.js 3.5.16 (https://github.com/mbostock/d3)

**CSS**
- Bootstrap 3.3.7 (http://getbootstrap.com/)
- Font Awesome 4.6.3 (http://fortawesome.github.io/Font-Awesome/)
...
Test cases have been created and tested using Jasmine v2.3.4, CasperJS v1.1.0-beta3, and PHPUnit 5.5.4.
