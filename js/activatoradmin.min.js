...
currentPage:1,perPage:10,totalPages:10},parse:function(a){return a}});var b=new ActivatorList;window.ActivatorItemView=Backbone.View.extend({tagName:"li",className:"well",template:_.template(e),events:{"click #toggle-activate":"toggleActivate","click img":"toggleImage"},initialize:function(){},render:function(){var a=this.model;if(""!=a.get("image")&&null!==a.get("image")&&"undefined"!=typeof appConfig&&appConfig.hasOwnProperty("imagePath")&&""!=appConfig.imagePath&&0!==a.get("image").indexOf(d+appConfig.imagePath)){var c=
d+appConfig.imagePath+a.get("image");a.set("image",c)}else if(""==a.get("image")||null===a.get("image"))c=d+"images/default.jpg",a.set("image",c);c=a.toJSON();"undefined"!=typeof appConfig&&appConfig.hasOwnProperty("show_delete")&&appConfig.show_delete?c.show_delete=appConfig.show_delete:c.show_delete=!1;"undefined"!=typeof appConfig&&appConfig.hasOwnProperty("show_info")&&appConfig.show_info?c.show_info=appConfig.show_info:c.show_info=!1;this.$el.html(this.template(c));this.$el.find("input").tooltip({placement:"top"});
